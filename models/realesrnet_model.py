...
class RealESRNetModel(SRModel):
    ...
    #         # JPEG compression
    #
    #         jpeg_p = paddle.uniform([out.size(0)], dtype='float32', min=self.opt['jpeg_range'][0], max=self.opt['jpeg_range'][1])
    ...
    #             # JPEG compression
    #             jpeg_p = paddle.uniform([out.size(0)], dtype='float32', min=self.opt['jpeg_range2'][0], max=self.opt['jpeg_range2'][1])
    #             out = paddle.clip(out, 0, 1)
    #             out = self.jpeger(out, quality=jpeg_p)
    #         else:
    #             # JPEG compression
